...
public class MySqliteIPDataBase {
    Context context;
    private MySqliteIPDBHelper dbHelper ;

    public MySqliteIPDataBase(Context context){
        this.context = context;
        dbHelper = new MySqliteIPDBHelper(context);
    }


    public long insertIPInfoTable(String orgId, String ipname , String appname){
    ...
    public void deleteOrgDetailTable(){
        SQLiteDatabase db= dbHelper.getWritableDatabase();
        db.execSQL("delete from "+ dbHelper.org_info_tbl);
    }
...
class MySqliteIPDBHelper extends SQLiteOpenHelper {
    private Context context;

    static final int db_version = 1; // strictly recommended to must not be changed

    static final String db_name = "HotelKot.bd";// strictly recommended to must not be changed

    static final String org_info_tbl = "ipdatabase";
...
//    static final String create_table_bind_anim_type_tbl = "CREATE TABLE IF NOT EXISTS "+bind_anim_type_tbl+"("+type_id_auto+" INTEGER PRIMARY KEY AUTOINCREMENT, "+type_animal_type_hindi+" VARCHAR, "+type_id_animal_type+" VARCHAR, "+type_OrgId+" VARCHAR);";
    ...
    static final String create_table_org_info = "CREATE TABLE IF NOT EXISTS "+org_info_tbl+"("+org_id_auto+" INTEGER PRIMARY KEY AUTOINCREMENT, "+ipname+" VARCHAR, "+appname+" VARCHAR);";
...
//    static final String drop_table_anim_shade_report_tbl = "DROP TABLE IF EXISTS "+anim_shade_report_tbl;
    ...
    public MySqliteIPDBHelper(Context context) {
...
//            db.execSQL(create_table_anim_shade_report_tbl);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        try {
            //db.execSQL(drop_table_basic);
            db.execSQL(drop_table_org_info);
//            db.execSQL(drop_table_login);
//            db.execSQL(drop_table_update_basic);
//            db.execSQL(drop_tableread_tags);
//            db.execSQL(drop_table_attn_send);
//            db.execSQL(drop_table_bind_anim_type_tbl);
//            db.execSQL(drop_table_bind_location_tbl);
//            db.execSQL(drop_table_read_tags_for_transfer_anim_location_tbl);
//            db.execSQL(drop_table_transfer_anim_location_tbl);
//            db.execSQL(drop_table_milk_production_tbl);
//            db.execSQL(drop_table_adoptive_profile_tbl);
//            db.execSQL(drop_table_anim_death_profile_tbl);
//            db.execSQL(drop_table_anim_immunization_tbl);
//            db.execSQL(drop_table_anim_post_immunization_tbl);
//            db.execSQL(drop_table_anim_disease_profile_tbl);
//            db.execSQL(drop_table_anim_total_present_report_tbl);
//            db.execSQL(drop_table_anim_shade_report_tbl);
            onCreate(db);
