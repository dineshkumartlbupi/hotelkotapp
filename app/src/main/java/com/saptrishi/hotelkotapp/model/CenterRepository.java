...
public class CenterRepository {
    ...
    private List<Product> listOfProductsAll = new ArrayList<Product>();
    ...
    public List<Product> getlistOfProductsAll() {
        return listOfProductsAll;
    }

    public void setListOfAllPRoduct(ArrayList<Product> listOfProductsAll) {
        this.listOfProductsAll = listOfProductsAll;
    }
