...
import com.saptrishi.hotelkotapp.model.entities.ProductCategoryModel;
...
//    public FakeWebServer(Context contex) {
//        this.contex = contex;
//    }
    ...
    public static FakeWebServer getFakeWebServer() {
        ...
        if (null == fakeServer) {
            //fakeServer = new FakeWebServer(contex);
    ...
    private void bind_item_pass(JSONArray per) throws JSONException {
        ArrayList<Product> productlist = new ArrayList<Product>();
        for (int i = 0; i < per.length(); i++) {
            JSONObject person = (JSONObject) per.get(i);
            Product obj=new Product(person.optString("ItemName"),
                                "",
                                "",
                                "0",
                                "0",
                                person.optString("ItemSaleRate"),
                                "0",
                                "",
                                person.optString("ItemCode"));

            //bindLocation.add(obj);
            productlist.add(obj);

        }
        CenterRepository.getCenterRepository().setListOfAllPRoduct(productlist);
    }

//    private void bind_item(String rest_code, String Subcate_ocde){
...
//                    }
//                    CenterRepository.getCenterRepository().setListOfAllPRoduct(productlist);
//                    Log.e("productlist service",""+productlist.size());
//
...
//    }
    ...
    public void getallproduct_sandeep(){
        ArrayList<Product> productlist = new ArrayList<Product>();
    ...
    public void getAllProductsmix_jarry(JSONArray  person) throws JSONException {

        //getallproduct_sandeep();
        bind_item_pass(person);

    }

//    public void getAllProductsmix(String rest_code, String Subcate_ocde)  {
//
//        //getallproduct_sandeep();
//        bind_item(rest_code,Subcate_ocde);
//
//
//    }
